...
Pre-validated FFmpeg filter chains — never dynamically assembled, never broken.
Each effect is tested independently. Simple eq= only (curves/hue break on many builds).
"""

# ── Color grades ──────────────────────────────────────────────────────────────
# Using eq= with gamma_r/gamma_b for color channel control — universally supported
COLOR_GRADES = {
...
# ── Letterbox bars — warzone/cinematic style ──────────────────────────────────
LETTERBOX = [
